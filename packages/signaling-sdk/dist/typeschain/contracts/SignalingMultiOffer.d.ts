...
export interface SignalingMultiOfferInterface extends Interface {
...
export interface SignalingMultiOffer extends BaseContract {
    connect(runner?: ContractRunner | null): SignalingMultiOffer;
    waitForDeployment(): Promise<this>;
    interface: SignalingMultiOfferInterface;
