...
export interface SignalingInterface extends Interface {
    getFunction(nameOrSignature: "UPGRADE_INTERFACE_VERSION" | "getAnswer" | "getOffer" | "initialize" | "owner" | "proxiableUUID" | "renounceOwnership" | "setAnswer" | "setOffer" | "transferOwnership" | "upgradeToAndCall"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Initialized" | "OwnershipTransferred" | "Upgraded" | "proposeAnswer" | "proposeOffer"): EventFragment;
    encodeFunctionData(functionFragment: "UPGRADE_INTERFACE_VERSION", values?: undefined): string;
    encodeFunctionData(functionFragment: "getAnswer", values: [AddressLike, AddressLike]): string;
    encodeFunctionData(functionFragment: "getOffer", values: [AddressLike]): string;
...
export interface Signaling extends BaseContract {
    ...
    getFunction(nameOrSignature: "getOffer"): TypedContractMethod<[offerer: AddressLike], [SignalStructOutput], "view">;
    ...
    getFunction(nameOrSignature: "setOffer"): TypedContractMethod<[offer: BytesLike], [void], "nonpayable">;
    ...
    filters: {
        ...
        "proposeOffer(address,tuple)": TypedContractEvent<proposeOfferEvent.InputTuple, proposeOfferEvent.OutputTuple, proposeOfferEvent.OutputObject>;
