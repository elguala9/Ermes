 ...
 */
export function testErmesConnection(db) {
    describe('ErmesConnection Factories', () => {
        ...
        describe('ErmesConnectionFactory', () => {
            it('should create a valid ErmesConnection instance', () => {
                const connection = ErmesConnectionFactory.createConnection(signalingHandler, factory, repository, testConnectionId);
                expect(connection).to.not.be.undefined;
                expect(connection.getIdConnection()).to.equal(testConnectionId);
            });
            it('should create connections with different IDs', () => {
                const connection1 = ErmesConnectionFactory.createConnection(signalingHandler, factory, repository, 'connection-1');
                const connection2 = ErmesConnectionFactory.createConnection(signalingHandler, factory, repository, 'connection-2');
        ...
        describe('Integration', () => {
            ...
            it('should support multiple connections in handler', () => {
                const handler = ErmesConnectionsHandlerFactory.createConnectionsHandler(db);
                const connection1 = ErmesConnectionFactory.createConnection(signalingHandler, factory, repository, 'conn-1');
                const connection2 = ErmesConnectionFactory.createConnection(signalingHandler, factory, repository, 'conn-2');
...
//# sourceMappingURL=ErmesConnectionFactories.spec.js.map