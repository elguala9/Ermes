...
import { ErmesMessageControlService, ErmesMessageControlServiceOpts, createMessageControlRepositoryWithState } from "ermes/index";
import { ClientWorkDB } from "workdb/ClientWorkDB";

export function testErmesMessageControlPersistence(
  createRepo: () => Promise<IErmesMessageControlRepository>,
  getDatabase: () => ClientWorkDB
) {
