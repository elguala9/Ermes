...
import { BookData, BookInput } from "ermes/index";
import { IErmesBookService } from "iermes/index";

export function testBook(
  service: IErmesBookService<BookInput, BookData>
) {
  describe('Book Tests', function () {
    ...
    describe('setAccount', function() {
      it('should set a new account with info', async function() {
        ...
        const bookInput: BookInput = { name: "Test Book" };
      ...
      it('should update existing account when calling setAccount again', async function() {
        ...
        const firstBook: BookInput = { name: "First Book" };
        const secondBook: BookInput = { name: "Second Book" };
    ...
    describe('updateAccount', function() {
      it('should update existing account', async function() {
        ...
        const originalBook: BookInput = { name: "Original Book" };
        const updateInfo: Partial<BookInput> = { name: "Updated Book" };
      ...
      it('should handle partial updates', async function() {
        ...
        const originalBook: BookInput = { name: "Original Book" };
        const partialUpdate: Partial<BookInput> = {}; // Empty update
      ...
      it('should throw error when updating non-existent account', async function() {
        ...
        const updateInfo: Partial<BookInput> = { name: "New Name" };
    ...
    describe('getAccount', function() {
      it('should get existing account', async function() {
        ...
        const bookInput: BookInput = { name: "Get Test Book" };
    ...
    describe('deleteAccount', function() {
      it('should delete existing account', async function() {
        ...
        const bookInput: BookInput = { name: "To Delete Book" };
    ...
    describe('Edge Cases and Error Handling', function() {
      it('should handle special characters in account IDs', async function() {
        ...
        const bookInput: BookInput = { name: "Special Chars Book" };
      ...
      it('should handle empty account ID', async function() {
        const emptyId = "";
        const bookInput: BookInput = { name: "Empty ID Book" };
      ...
      it('should handle very long account IDs', async function() {
        ...
        const bookInput: BookInput = { name: "Long ID Book" };
      ...
      it('should handle unicode characters in book names', async function() {
        ...
        const unicodeBook: BookInput = { name: "📚 Unicode Book 中文 🎉" };
