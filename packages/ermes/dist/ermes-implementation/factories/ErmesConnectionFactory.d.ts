 ...
 */
export declare class ErmesConnectionFactory {
    /**
     ...
     */
    static createConnection(signalingHandler: IErmesSignalingHandler<PeerType>, factory: IErmesFactory<PeerType>, repository: IErmesRepository, connectionId: IdPeer): ErmesConnection;
}
