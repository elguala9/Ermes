...
export class ErmesService {
     ...
     */
    constructor({ maxBuffer, maxByte, repository, idHandler, callbackOnDataArrived, ermesStorageAndCaching, ermesMessageControlService, missingMessagesCheckIntervalMs, missingMessagesThreshold }) {
     ...
     */
    startMissingMessagesCheck(intervalMs) {
     ...
     */
    async checkAndRequestMissingMessages() {
        if (this.ermesMessageControlService === undefined) {
            return;
        }
     ...
     */
    async otherPeerMissingMessages() {
        if (this.ermesMessageControlService === undefined)
            return [];
