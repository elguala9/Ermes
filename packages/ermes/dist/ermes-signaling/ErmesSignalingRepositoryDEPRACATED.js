/*! $RESERVED$ */
export const DISCONNECTED_FLAG__ = "DISCONNECTED";
export class ErmesSignalingRepository__ {
    ...
    async disconnect() {
        await this.signaling.setOffer(DISCONNECTED_FLAG__);
    }
    getIdAccount() {
    ...
    compareSignalMessage(signal_1, signal_2) {
        return ErmesSignalingRepository__.compareSignalMessage(signal_1, signal_2);
    }
...
//# sourceMappingURL=ErmesSignalingRepositoryDEPRACATED.js.map